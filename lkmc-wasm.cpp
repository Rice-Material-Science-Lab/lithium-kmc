     ...
     * emcc lkmc-wasm.cpp -o public/lkmc-wasm.js -O3 -fexceptions -sEXPORT_ES6 -sMODULARIZE -sEXPORTED_FUNCTIONS="['_init_simulation','_run_steps','_get_lattice','_get_width','_get_height','_get_step','_get_time', '_get_snapshot_json', '_cleanup_simulation']"
     *
